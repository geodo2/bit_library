...
@WebServlet(name = "RentalPageServlet", value = "/RentalPageServlet")
public class RentalPageServlet extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            try {
                ...
                context.getRequestDispatcher("/RentalPage.jsp").forward(request, response);
            } catch (SQLException e) {
                e.printStackTrace();
                // 오류 처리
